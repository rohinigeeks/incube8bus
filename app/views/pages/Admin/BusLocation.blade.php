        ...
        <div class="col-md-4">
            ...
            <div>
                 <ul class="nav nav-pills nav-stacked" role="tablist">
                    ...
                    <li class="active"><a href="#">Bus Location</a></li>    
                  </ul>
            </div>
        </div>
        <div class="col-md-8">
            ...
            <div>
                {{ Form::open(array('action' => '/', 'role' => 'form', 'id' => 'RegisterForm')); }}
                    ...
                    <div class="form-group">
                        <label for="emmissionstandard">emmissionstandard:</label>
                        {{ Form::text('emmissionstandard', '', array('class' => 'form-control', 'placeholder' => 'Enter entry')); }}    
                    </div>
                    <div class="form-group">
                        {{Form::submit('Add');}}
                    </div>    
